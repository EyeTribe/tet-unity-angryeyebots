...
/* @TheEyeTribe
 * 
 * Handle to eye tracking script. Attached to 'main cam'.
 */
private var gazeScript : GazeAngryBotsWrap;
...
function Start () {
    ...
    /* @TheEyeTribe
     * 
     * Getting handle to script attached to main cam
     */ 
	gazeScript = mainCamera.GetComponent(typeof(GazeAngryBotsWrap)) as GazeAngryBotsWrap;
}
